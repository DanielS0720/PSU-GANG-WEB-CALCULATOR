...
const SOCIAL_LINKS: { name: string; href: string; icon: React.ReactNode }[] = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/PSUG4ng",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/psugangts/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-5 w-5">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@psugang",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-5 w-5">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@PSUGANG-bx5hn",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-5 w-5">
  ...
  return (
    <div className="min-h-dvh flex flex-col">
      ...
      <footer className="border-t border-[var(--color-surface)]">
        <div className="mx-auto w-full max-w-3xl px-6 py-6 flex flex-col items-center gap-4">
